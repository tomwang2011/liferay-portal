...
public class ResourcePermissionUtil {
	...
	*/
	public static List<ResourcePermission> findByC_N_S_R(long companyId,
		...
		return getPersistence().findByC_N_S_R(companyId, names, scope, roleIds);
	}
	...
	*/
	public static List<ResourcePermission> findByC_N_S_R(long companyId,
		...
		return getPersistence()
				   .findByC_N_S_R(companyId, names, scope, roleIds, start, end);
	}
	...
	* @return the number of matching resource permissions
	*/
	public static int countByC_N_S_R(long companyId, String[] names, int scope,
		long[] roleIds) {
		return getPersistence().countByC_N_S_R(companyId, names, scope, roleIds);
	}
