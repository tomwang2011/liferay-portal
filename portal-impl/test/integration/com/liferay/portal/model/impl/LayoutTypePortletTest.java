...
public class LayoutTypePortletTest {
	...
	@Test
	public void testGetAllPortletsWithNoNonStaticPortlets() throws Exception {
		List<Portlet> portlets = _layoutTypePortlet.getAllPortlets();

		int nonStaticPortletCount = 0;

		for (Portlet portlet : portlets) {
			if (!portlet.isStatic()) {
				nonStaticPortletCount++;
			}
		}

		Assert.assertEquals(0, nonStaticPortletCount);
	}
