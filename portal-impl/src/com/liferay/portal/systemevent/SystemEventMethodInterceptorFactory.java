...
public class SystemEventMethodInterceptorFactory
	...
	public MethodInterceptor create(
		...
		return new SystemEventMethodInterceptor();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SystemEventMethodInterceptorFactory.class);

	private static class SystemEventMethodInterceptor
		extends AnnotatedMethodInterceptor<SystemEvent> {
		...
		public void afterReturning(
			...
			if ((systemEventHierarchyEntry != null) &&
				...
				SystemEventLocalServiceUtil.addSystemEvent(
					...
					getUuid(classedModel), referrerClassName,
		...
		protected boolean isValid(
			MethodInvocation methodInvocation, int phase) {
			...
			if (!AuditedModel.class.isAssignableFrom(parameterType) &&
				...
				if (_log.isDebugEnabled()) {
					...
					sb.append(" must implement AuditedModel, GroupedModel, ");
