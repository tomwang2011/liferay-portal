...
package com.liferay.portal.tools.bytecode.transformer;
...
public class ConstructorMethodVisitor extends MethodVisitor {
	...
	public ConstructorMethodVisitor(int api, MethodVisitor mv, String superName) {
		super(api, null);
	...
	public void visitCode() {
		...
		_methodMethodVisitor.visitMethodInsn(Opcodes.INVOKESPECIAL, _superName, "<init>", "()V", false);
