...
public class IsCacheableWhenThereAreNoStaticPortletsAndNoEmbeddedPortletsTest {
	...
	public void testShouldReturnFalseIfANonlayoutCacheableRootPortletIsInstalled()
		...
		LayoutTestUtil.addPortletToLayout(
			TestPropsValues.getUserId(), LayoutTypePortletImplTestHelper.layout,
		...
		LayoutTestUtil.addPortletToLayout(
			TestPropsValues.getUserId(), LayoutTypePortletImplTestHelper.layout,
			cacheablePortletId, "column-1", new HashMap<String, String[]>());
	...
	public void testShouldReturnTrueIfInstalledRootPortletsAreLayoutCacheable()
		...
		try {
			...
			LayoutTestUtil.addPortletToLayout(
				...
				LayoutTypePortletImplTestHelper.layout, cacheablePortletId,
