...
public class IsCacheableWhenThereAreEmbeddedPortletsAndNoStaticPortletsTest {
	...
	public void setUp() throws Exception {
		LayoutTypePortletImplTestHelper.setUp();
	}

	@After
	public void tearDown() {
		LayoutTypePortletImplTestHelper.tearDown();
	}
	...
	public void testShouldReturnFalseIfThereIsANonlayoutCacheableRootPortlet()
		...
		PortletPreferencesLocalServiceUtil.addPortletPreferences(
			...
			LayoutTypePortletImplTestHelper.layout.getPlid(),
			noncacheablePortlet.getPortletId(), noncacheablePortlet, null);

		PortletPreferencesLocalServiceUtil.addPortletPreferences(
			TestPropsValues.getCompanyId(),
			LayoutTypePortletImplTestHelper.layout.getGroupId(),
		...
		LayoutTypePortletImplTestHelper.addLayoutPortletPreferences(
			LayoutTypePortletImplTestHelper.layout, cacheablePortlet);

		Assert.assertFalse(
			LayoutTypePortletImplTestHelper.layoutTypePortlet.isCacheable());
	}
	...
	public void testShouldReturnTrueIfAllRootPortletsAreLayoutCacheable()
		...
		try {
			...
			Assert.assertTrue(
				LayoutTypePortletImplTestHelper.layoutTypePortlet.
					isCacheable());
		}
		finally {
			PropsUtil.set(
