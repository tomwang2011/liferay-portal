...
<c:if test="<%= articleDisplay.isPaginate() %>">
	...
	<liferay-portlet:renderURL plid="<%= JournalWebUtil.getPreviewPlid(article, themeDisplay) %>" varImpl="previewArticleContentURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
