...
public class FreeMarkerTemplate extends AbstractSingleResourceTemplate {
	...
	private class CachableDefaultMapAdapter
		...
		public TemplateModel getAPI() throws TemplateModelException {
			return ((ObjectWrapperWithAPISupport)getObjectWrapper()).wrapAsAPI(
				_innerMap);
		}
		...
		public TemplateCollectionModel keys() {
			return new SimpleCollection(_innerMap.keySet(), getObjectWrapper());
		}
		...
		public TemplateCollectionModel values() {
			return new SimpleCollection(_innerMap.values(), getObjectWrapper());
		}
