...
public class ScreensJournalArticleServiceImpl
	...
	public String getJournalArticleContent(long classPK, Locale locale)
		...
		_checkPermission(journalArticleResource);
	...
	private void _checkPermission(JournalArticle article)
		throws PortalException {
	...
	private void _checkPermission(JournalArticleResource journalArticleResource)
		throws PortalException {
