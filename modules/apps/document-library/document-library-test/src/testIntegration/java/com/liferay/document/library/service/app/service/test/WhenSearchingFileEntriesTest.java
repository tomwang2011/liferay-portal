...
public class WhenSearchingFileEntriesTest extends BaseDLAppTestCase {
	...
	public void testShouldFindFileEntryByAssetTagName() throws Exception {
		...
		DLAppServiceTestHelper.search(fileEntry, "hello", true);
		DLAppServiceTestHelper.search(fileEntry, "world", true);
		DLAppServiceTestHelper.search(fileEntry, "liferay", false);
	}
	...
	public void testShouldFindFileEntryByAssetTagNameAfterUpdate()
		...
		DLAppServiceTestHelper.search(fileEntry, "hello", true);
		DLAppServiceTestHelper.search(fileEntry, "world", true);
		DLAppServiceTestHelper.search(fileEntry, "liferay", true);
	}

	@Ignore
	@Test
	public void testShouldFindFileEntryInRootFolder() throws Exception {
		DLAppServiceTestHelper.searchFile(
