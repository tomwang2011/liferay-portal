...
public class DDMTemplateUtil {
	...
	* @return the matching ddm templates
	*/
	public static List<DDMTemplate> findByG_C_T(long[] groupIds,
		long classNameId, java.lang.String templateKey) {
		return getPersistence().findByG_C_T(groupIds, classNameId, templateKey);
	}
	...
	*/
	public static List<DDMTemplate> findByG_C_T(long[] groupIds,
		long classNameId, java.lang.String templateKey, int start, int end) {
		return getPersistence()
				   .findByG_C_T(groupIds, classNameId, templateKey, start, end);
	}
	...
	* @return the number of matching ddm templates
	*/
	public static int countByG_C_T(long[] groupIds, long classNameId,
		java.lang.String templateKey) {
		return getPersistence().countByG_C_T(groupIds, classNameId, templateKey);
	}
	...
	*/
	public static int filterCountByG_C_T(long groupId, long classNameId,
		java.lang.String templateKey) {
		return getPersistence()
				   .filterCountByG_C_T(groupId, classNameId, templateKey);
	}
	...
	* @return the number of matching ddm templates that the user has permission to view
	*/
	public static int filterCountByG_C_T(long[] groupIds, long classNameId,
		java.lang.String templateKey) {
		return getPersistence()
				   .filterCountByG_C_T(groupIds, classNameId, templateKey);
	}
